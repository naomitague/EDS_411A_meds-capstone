...
* put all tests assoicated with a given function/module in a single file
* put all tests in a directory called *tests*
...
# fix issues (ideally with a git commit)
source("R/compute_NPV_better.R")
test_file("tests/test_compute_NPV.R")
